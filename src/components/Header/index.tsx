...
import {Button, ButtonGroup, Col, Collapse, Container, Form, Row} from "react-bootstrap"
import "./style.css"
        ...
        <Row className="py-3 px-2 justify-content-between">
          ...
          <Col md={2}>
            <div className="input-group input-group-sm">
              <input type="text" className="form-control header-search" aria-label="Sizing example input"
                    ...
                    <Col md={9}>
                      <Row>
                        <Col md="2" className="text-start position-relative">
                          <label htmlFor="datePicker" className="form-label position-absolute bottom-100">Release
                            date</label>
                          <input type="date"
                                 id="datePicker"
                                 value="2018-07-22"
